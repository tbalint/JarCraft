 ...
 */
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_startClient(JNIEnv *env, jobject jObj, jobject classRef)
{
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_drawHealth(JNIEnv *env, jobject jObj, jboolean enable)
{
	showHealth = enable;
}

JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_drawTargets(JNIEnv *env, jobject jObj, jboolean enable)
{
	showTargets = enable;
}

JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_drawIDs(JNIEnv *env, jobject jObj, jboolean enable)
{
	showIDs = enable;
}

JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_enableUserInput(JNIEnv *env, jobject jObj)
{
	Broodwar->enableFlag(Flag::UserInput);
}

JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_enablePerfectInformation(JNIEnv *env, jobject jObj) 
{
	Broodwar->enableFlag(Flag::CompleteMapInformation);
}

JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_setGameSpeed(JNIEnv *env, jobject jObj, jint speed)
{
...
JNIEXPORT jint JNICALL Java_javabot_JNIBWAPI_getGameFrame(JNIEnv *env, jobject jObj) 
{
	return Broodwar->getFrameCount();
}

JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getPlayerInfo(JNIEnv *env, jobject jObj)
{
  int index = 0;
...
JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getPlayerUpdate(JNIEnv *env, jobject jObj, jint playerID)
{
  int index = 0;
...
JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getResearchStatus(JNIEnv *env, jobject jObj, jint playerID)
{
  int index = 0;
  Player* p = Broodwar->getPlayer(playerID);
...
JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getUpgradeStatus(JNIEnv *env, jobject jObj, jint playerID)
{
  int index = 0;
  Player* p = Broodwar->getPlayer(playerID);
...
JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getUnitTypes(JNIEnv *env, jobject jObj) 
{
  int index = 0;
  ...
  for(std::set<UnitType>::iterator i=types.begin();i!=types.end();i++)
  {
	...
	intBuf[index++] = i->airWeapon() !=  WeaponTypes::None ? 1 : 0;
	intBuf[index++] = i->groundWeapon()  !=  WeaponTypes::None ? 1 : 0;
...
JNIEXPORT jstring JNICALL Java_javabot_JNIBWAPI_getUnitTypeName(JNIEnv *env, jobject jObj, jint typeID) 
{
	return jEnv->NewStringUTF(unitTypeMap[typeID].getName().c_str());
}

JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getTechTypes(JNIEnv *env, jobject jObj)
{
  int index = 0;
...
JNIEXPORT jstring JNICALL Java_javabot_JNIBWAPI_getTechTypeName(JNIEnv *env, jobject jObj, jint techID)
{
	return jEnv->NewStringUTF(techTypeMap[techID].getName().c_str());
}

JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getUpgradeTypes(JNIEnv *env, jobject jObj)
{
  int index = 0;
...
JNIEXPORT jstring JNICALL Java_javabot_JNIBWAPI_getUpgradeTypeName(JNIEnv *env, jobject jObj, jint upgradeID)
{
	return jEnv->NewStringUTF(upgradeTypeMap[upgradeID].getName().c_str());
}

JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getWeaponTypes(JNIEnv *env, jobject jObj)
{
  int index = 0;
...
JNIEXPORT jstring JNICALL Java_javabot_JNIBWAPI_getWeaponTypeName(JNIEnv *env, jobject jObj, jint weaponID)
{
	return jEnv->NewStringUTF(weaponTypeMap[weaponID].getName().c_str());
}

JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getUnitSizeTypes(JNIEnv *env, jobject jObj) 
{
  int index = 0;
...
JNIEXPORT jstring JNICALL Java_javabot_JNIBWAPI_getUnitSizeTypeName(JNIEnv *env, jobject jObj, jint sizeID)
{
	return jEnv->NewStringUTF(unitSizeTypeMap[sizeID].getName().c_str());
}

JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getBulletTypes(JNIEnv *env, jobject jObj)
{
  int index = 0;
...
JNIEXPORT jstring JNICALL Java_javabot_JNIBWAPI_getBulletTypeName(JNIEnv *env, jobject jObj, jint bulletID)
{
	return jEnv->NewStringUTF(bulletTypeMap[bulletID].getName().c_str());
}

JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getDamageTypes(JNIEnv *env, jobject jObj)
{
  int index = 0;
...
JNIEXPORT jstring JNICALL Java_javabot_JNIBWAPI_getDamageTypeName(JNIEnv *env, jobject jObj, jint damageID)
{
	return jEnv->NewStringUTF(damageTypeMap[damageID].getName().c_str());
}

JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getExplosionTypes(JNIEnv *env, jobject jObj)
{
  int index = 0;
...
JNIEXPORT jstring JNICALL Java_javabot_JNIBWAPI_getExplosionTypeName(JNIEnv *env, jobject jObj, jint explosionID)
{
	return jEnv->NewStringUTF(explosionTypeMap[explosionID].getName().c_str());
}

JNIEXPORT jstring JNICALL Java_javabot_JNIBWAPI_getUnitCommandTypeName(JNIEnv *env, jobject jObj, jint unitCommandID)
{
	return jEnv->NewStringUTF(unitCommandTypeMap[unitCommandID].getName().c_str());
}

JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getUnitCommandTypes(JNIEnv *env, jobject jObj)
{
  int index = 0;
...
JNIEXPORT jstring JNICALL Java_javabot_JNIBWAPI_getOrderTypeName(JNIEnv *env, jobject jObj, jint unitCommandID)
{
	return jEnv->NewStringUTF(orderTypeMap[unitCommandID].getName().c_str());
}

JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getOrderTypes(JNIEnv *env, jobject jObj)
{
  int index = 0;
 ...
 */
JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getUnits(JNIEnv *env, jobject jObj) 
{
  int index = 0;
...
JNIEXPORT jint JNICALL Java_javabot_JNIBWAPI_getMapWidth(JNIEnv *env, jobject jObj)
{
	return Broodwar->mapWidth();
}

JNIEXPORT jint JNICALL Java_javabot_JNIBWAPI_getMapHeight(JNIEnv *env, jobject jObj)
{
	return Broodwar->mapHeight();
}

JNIEXPORT jstring JNICALL Java_javabot_JNIBWAPI_getMapName(JNIEnv *env, jobject jObj)
{
	return jEnv->NewStringUTF(Broodwar->mapFileName().c_str());
}

JNIEXPORT jstring JNICALL Java_javabot_JNIBWAPI_getMapHash(JNIEnv *env, jobject jObj)
{
	return jEnv->NewStringUTF(Broodwar->mapHash().c_str());
}

JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getHeightData(JNIEnv *env, jobject jObj)
{
  int index = 0;
...
JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getWalkableData(JNIEnv *env, jobject jObj)
{
...
JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getBuildableData(JNIEnv *env, jobject jObj)
{
  int index = 0;
  int width = Broodwar->mapWidth();
  int height = Broodwar->mapHeight();
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_analyzeTerrain(JNIEnv *env, jobject jObj)
{
	regionMap.clear();
	BWTA::readMap();
	BWTA::analyze();
...
JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getChokePoints(JNIEnv *env, jobject jObj)
{
  int index = 0;
...
JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getRegions(JNIEnv *env, jobject jObj)
{
  int index = 0;
...
JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getPolygon(JNIEnv *env, jobject jObj, jint regionID)
{
  int index = 0;
  std::set<BWTA::Region*> regions = BWTA::getRegions();
  for (std::set<BWTA::Region*>::iterator i=regions.begin();i!=regions.end();i++)
...
JNIEXPORT jintArray JNICALL Java_javabot_JNIBWAPI_getBaseLocations(JNIEnv *env, jobject jObj)
{
  int index = 0;
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_attack__III(JNIEnv *env, jobject jObj, jint unitID, jint x, jint y) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_attack__II(JNIEnv *env, jobject jObj, jint unitID, jint targetID){
	Unit* unit = Broodwar->getUnit(unitID);
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_build(JNIEnv *env, jobject jObj, jint unitID, jint tx, jint ty, jint typeID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_buildAddon(JNIEnv *env, jobject jObj, jint unitID, jint typeID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		if (unitTypeMap.count(typeID) > 0) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_train(JNIEnv *env, jobject jObj, jint unitID, jint typeID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		if (unitTypeMap.count(typeID) > 0)
		{
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_morph(JNIEnv *env, jobject jObj, jint unitID, jint typeID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		if (unitTypeMap.count(typeID) > 0) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_research(JNIEnv *env, jobject jObj, jint unitID, jint techID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_upgrade(JNIEnv *env, jobject jObj, jint unitID, jint upgradeID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_setRallyPoint__III(JNIEnv *env, jobject jObj, jint unitID, jint x, jint y){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_setRallyPoint__II(JNIEnv *env, jobject jObj, jint unitID, jint targetID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	Unit* target = Broodwar->getUnit(targetID);
	if (unit != NULL && target != NULL) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_move(JNIEnv *env, jobject jObj, jint unitID, jint x, jint y){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_patrol(JNIEnv *env, jobject jObj, jint unitID, jint x, jint y){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_holdPosition(JNIEnv *env, jobject jObj, jint unitID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		unit->holdPosition();
	}
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_stop(JNIEnv *env, jobject jObj, jint unitID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		unit->stop();
	}
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_follow(JNIEnv *env, jobject jObj, jint unitID, jint targetID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	Unit* target = Broodwar->getUnit(targetID);
	if (unit != NULL && target != NULL) {
		unit->follow(target);
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_gather(JNIEnv *env, jobject jObj, jint unitID, jint targetID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	Unit* target = Broodwar->getUnit(targetID);
	if (unit != NULL && target != NULL) {
		unit->gather(target);
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_returnCargo(JNIEnv *env, jobject jObj, jint unitID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		unit->returnCargo();
	}
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_repair(JNIEnv *env, jobject jObj, jint unitID, jint targetID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	Unit* target = Broodwar->getUnit(targetID);
	if (unit != NULL && target != NULL) {
		unit->repair(target);
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_burrow(JNIEnv *env, jobject jObj, jint unitID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		unit->burrow();
	}
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_unburrow(JNIEnv *env, jobject jObj, jint unitID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		unit->unburrow();
	}
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_cloak(JNIEnv *env, jobject jObj, jint unitID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		unit->cloak();
	}
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_decloak(JNIEnv *env, jobject jObj, jint unitID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		unit->decloak();
	}
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_siege(JNIEnv *env, jobject jObj, jint unitID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		unit->siege();
	}
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_unsiege(JNIEnv *env, jobject jObj, jint unitID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		unit->unsiege();
	}
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_lift(JNIEnv *env, jobject jObj, jint unitID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		unit->lift();
	}
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_land(JNIEnv *env, jobject jObj, jint unitID, jint tx, jint ty){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_load(JNIEnv *env, jobject jObj, jint unitID, jint targetID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	Unit* target = Broodwar->getUnit(targetID);
	if (unit != NULL && target != NULL) {
		unit->load(target);
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_unload(JNIEnv *env, jobject jObj, jint unitID, jint targetID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	Unit* target = Broodwar->getUnit(targetID);
	if (unit != NULL && target != NULL) {
		unit->unload(target);
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_unloadAll__I(JNIEnv *env, jobject jObj, jint unitID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		unit->unloadAll();
	}
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_unloadAll__III(JNIEnv *env, jobject jObj, jint unitID, jint x, jint y){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_rightClick__III(JNIEnv *env, jobject jObj, jint unitID, jint x, jint y){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_rightClick__II(JNIEnv *env, jobject jObj, jint unitID, jint targetID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	Unit* target = Broodwar->getUnit(targetID);
	if (unit != NULL && target != NULL) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_haltConstruction(JNIEnv *env, jobject jObj, jint unitID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_cancelConstruction(JNIEnv *env, jobject jObj, jint unitID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_cancelAddon(JNIEnv *env, jobject jObj, jint unitID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		unit->cancelAddon();
	}
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_cancelTrain(JNIEnv *env, jobject jObj, jint unitID, jint slot){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_cancelMorph(JNIEnv *env, jobject jObj, jint unitID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		unit->cancelMorph();
	}
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_cancelResearch(JNIEnv *env, jobject jObj, jint unitID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		unit->cancelResearch();
	}
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_cancelUpgrade(JNIEnv *env, jobject jObj, jint unitID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		unit->cancelUpgrade();
	}
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_useTech__II(JNIEnv *env, jobject jObj, jint unitID, jint techID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		if (techTypeMap.count(techID) > 0) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_useTech__IIII(JNIEnv *env, jobject jObj, jint unitID, jint techID, jint x, jint y){ 
	Unit* unit = Broodwar->getUnit(unitID);
	if (unit != NULL) {
		if (techTypeMap.count(techID) > 0) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_useTech__III(JNIEnv *env, jobject jObj, jint unitID, jint techID, jint targetID){ 
	Unit* unit = Broodwar->getUnit(unitID);
	Unit* target = Broodwar->getUnit(targetID);
	if (unit != NULL && target != NULL) {
		if (techTypeMap.count(techID) > 0) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_drawBox(JNIEnv *env, jobject jObj, jint left, jint top, jint right, jint bottom, jint color, jboolean fill, jboolean screenCoords)
{
  if (screenCoords) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_drawCircle(JNIEnv *env, jobject jObj, jint x, jint y, jint radius, jint color, jboolean fill, jboolean screenCoords)
{
  if (screenCoords) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_drawLine(JNIEnv *env, jobject jObj, jint x1, jint y1, jint x2, jint y2, jint color, jboolean screenCoords)
{
  if (screenCoords) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_drawDot(JNIEnv *env, jobject jObj, jint x, jint y, jint color, jboolean screenCoords)
{
  if (screenCoords) {
...
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_drawText(JNIEnv *env, jobject jObj, jint x, jint y, jstring msg, jboolean screenCoords)
{
...
JNIEXPORT jboolean JNICALL Java_javabot_JNIBWAPI_hasCreep(JNIEnv *env, jobject jObj, jint tx, jint ty)
{
	return Broodwar->hasCreep(tx, ty);
}

/////////////canBuildHere Definition/////////////
JNIEXPORT jboolean JNICALL Java_javabot_JNIBWAPI_canBuildHere(JNIEnv *env, jobject jObj, jint unitID, jint tx, jint ty, jint utypeID, jboolean checkExplored)
{
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_javabot_JNIBWAPI_setCommandOptimizationLevel (JNIEnv * env, jobject jObj, jint level)
{
	Broodwar->setCommandOptimizationLevel(level);
}

JNIEXPORT jboolean JNICALL Java_javabot_JNIBWAPI_isVisible(JNIEnv *, jobject, jint tx, jint ty)
{
		return Broodwar->isVisible(TilePosition(tx, ty));
}

JNIEXPORT jboolean JNICALL Java_javabot_JNIBWAPI_isExplored(JNIEnv *, jobject, jint tx, jint ty)
{
		return Broodwar->isExplored(TilePosition(tx, ty));
}
